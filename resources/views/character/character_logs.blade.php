...
{!! breadcrumbs(['geno Slot Masterlist' => 'genos', $character->fullName => $character->url, 'Change Log' => $character->url.'/change-log']) !!}
@else
...
<div class="mb-4 logs-table">
    <div class="logs-table-header">
        <div class="row">
            <div class="col-6 col-md-2"><div class="logs-table-cell">Edited By</div></div>
            <div class="col-6 col-md-8"><div class="logs-table-cell">Log</div></div>
